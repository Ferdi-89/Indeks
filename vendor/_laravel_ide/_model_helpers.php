...
namespace App\Models {
     ...
     * @method static mixed insertOrIgnoreReturning(array $values, array|string $uniqueBy, array $returning)
     ...
     * @property string $title_paket
     * @property string $id_paket
     * @method static \Illuminate\Database\Eloquent\Builder<paket>|paket whereIdPaket($value)
     * @method static \Illuminate\Database\Eloquent\Builder<paket>|paket whereTitlePaket($value)
     * @method static \Illuminate\Database\Eloquent\Builder<paket>|paket whereHargaPaket($value)
     * @method static \Illuminate\Database\Eloquent\Builder<paket>|paket whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<paket>|paket whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<paket>|paket newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<paket>|paket newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<paket>|paket query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<paket>|paket timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<pendaftaran>|pendaftaran whereLongtitude($value)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<pendaftaran>|pendaftaran timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @property string $text_pengumuman
     * @property string $id_pengumuman
     * @method static \Illuminate\Database\Eloquent\Builder<pengumuman>|pengumuman whereIdPengumuman($value)
     * @method static \Illuminate\Database\Eloquent\Builder<pengumuman>|pengumuman whereTextPengumuman($value)
     * @method static \Illuminate\Database\Eloquent\Builder<pengumuman>|pengumuman whereTema($value)
     * @method static \Illuminate\Database\Eloquent\Builder<pengumuman>|pengumuman whereValidStart($value)
     * @method static \Illuminate\Database\Eloquent\Builder<pengumuman>|pengumuman whereValidEnd($value)
