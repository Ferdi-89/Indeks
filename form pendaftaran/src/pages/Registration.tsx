...
import { MessageSquare, User, MapPin, Home, Phone, UploadCloud, HeadphonesIcon, CheckCircle } from 'lucide-react';
...
export default function Registration() {
  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen bg-[#f1f5f9] font-sans pb-20 flex flex-col">
        {/* Navbar Minimalist */}
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-200 max-w-lg w-full text-center space-y-6">
            ...
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Pendaftaran Berhasil!</h2>
            <p className="text-slate-600 leading-relaxed text-[15px]">
              Terima kasih, data pendaftaran Anda telah kami terima dengan baik. Teknisi kami akan segera menghubungi Anda melalui nomor telepon / WhatsApp yang didaftarkan untuk mengatur jadwal survei dan instalasi.
            </p>
            <div className="pt-6">
              <button 
                onClick={() => window.location.reload()}
                className="w-full bg-[#1e40af] text-white font-bold px-8 py-3.5 rounded-xl hover:bg-[#1e3a8a] transition shadow text-sm"
              >
                Kembali ke Beranda
              </button>
            </div>
