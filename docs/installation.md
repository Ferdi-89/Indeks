...
### 4. Masalah Izin Akses Berkas (Permission Denied)
*   **Penyebab**: Server web tidak memiliki hak akses menulis ke direktori internal Laravel.
*   **Solusi**: Ubah hak akses direktori storage dan bootstrap cache (terutama pada sistem Linux/macOS):
    ```bash
